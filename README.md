...
> **No-ROS version**: a zero-dependency C++17 port of this package lives in [`noros/`](noros/) — same field, same SC1–SC7 scoring, same standardized maps, but builds with only a compiler (`./noros/build.sh`). It ships **six verified autonomous routines** (north_goal 27–0, south_route 22–5, midfield_push 14–6, west_goal 27–0, center_goal 40–0, cup_cover_test 17–0). See [`noros/README.md`](noros/README.md).
